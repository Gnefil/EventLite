...
public class VenuesController {
	...
	public String deleteById(@PathVariable("id") long id) {
		...
		for (Event event : events) {
			Venue eventVenue = event.getVenue();

			if (eventVenue.getId() == id) {
				isVenueEmpty = false;
			}
		}
	...
	public String updateVenue(@RequestBody @Valid @ModelAttribute Venue venue, BindingResult errors, Model model,
	...
	public String createVenue(@RequestBody @Valid @ModelAttribute Venue venue, BindingResult errors, Model model,
